...
class PackedDataset(IterableDataset):
    def __init__(
        ...
        self._dtype, self._chunk_size, self._n_blocks = self._read_first_file_header()
    ...
    def _read_first_file_header(self):
        if len(self._filenames) == 0:
            return None, None, None
        return self._read_header(self._filenames[0])
    ...
    def _read_header(self, path):
        ...
        return dtype, chunk_size, chunk_size // self._block_size

    def __len__(self):
        if self._n_blocks is None:
            return 0
        return len(self._filenames) * self._n_blocks
